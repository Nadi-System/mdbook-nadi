...
pub type OutputHandler = fn(Vec<Event<'static>>, String) -> Vec<Event<'static>>;
...
pub fn output_verbose(mut pre: Vec<Event<'static>>, text: String) -> Vec<Event<'static>> {
    pre.extend(vec![
...
pub fn output_markdown(mut pre: Vec<Event<'static>>, text: String) -> Vec<Event<'static>> {
